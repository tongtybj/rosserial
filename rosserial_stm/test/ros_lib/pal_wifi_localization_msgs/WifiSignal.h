#ifndef _ROS_pal_wifi_localization_msgs_WifiSignal_h
#define _ROS_pal_wifi_localization_msgs_WifiSignal_h
...
namespace pal_wifi_localization_msgs
{
  ...
  class WifiSignal : public ros::Msg
  {
    public:
      std_msgs::String id;
      float mean;
    ...
    const char * getType(){ return "pal_wifi_localization_msgs/WifiSignal"; };
    const char * getMD5(){ return "d6a79c360f114b44aaa8b522b2621591"; };
