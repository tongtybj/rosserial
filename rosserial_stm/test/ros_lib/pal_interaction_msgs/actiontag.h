#ifndef _ROS_pal_interaction_msgs_actiontag_h
#define _ROS_pal_interaction_msgs_actiontag_h
...
namespace pal_interaction_msgs
{
  ...
  class actiontag : public ros::Msg
  {
    public:
      const char* key;
      const char* value;
    ...
    const char * getType(){ return "pal_interaction_msgs/actiontag"; };
