...
namespace nao_interaction_msgs
{
  ...
  class LandmarkDetected : public ros::Msg
  {
    ...
    LandmarkDetected():
      header(),
      mark_ids_length(0), mark_ids(NULL),
      shape_alpha_length(0), shape_alpha(NULL),
      shape_beta_length(0), shape_beta(NULL),
      shape_sizex_length(0), shape_sizex(NULL),
      shape_sizey_length(0), shape_sizey(NULL),
      camera_local_pose(),
      camera_world_pose(),
      camera_name()
    {
