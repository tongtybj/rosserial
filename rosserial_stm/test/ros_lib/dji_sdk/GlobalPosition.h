#ifndef _ROS_dji_sdk_GlobalPosition_h
#define _ROS_dji_sdk_GlobalPosition_h
  ...
  class GlobalPosition : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_height.base >> (8 * 3)) & 0xFF;
      ...
      u_health.real = this->health;
      *(outbuffer + offset + 0) = (u_health.base >> (8 * 0)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_health.base = 0;
      u_health.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->health = u_health.real;
      offset += sizeof(this->health);
     return offset;
    }

    const char * getType(){ return "dji_sdk/GlobalPosition"; };
    const char * getMD5(){ return "10784f0f63ab6f41e201fee714fabb2a"; };
