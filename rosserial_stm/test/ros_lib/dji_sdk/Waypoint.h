#ifndef _ROS_dji_sdk_Waypoint_h
#define _ROS_dji_sdk_Waypoint_h
...
namespace dji_sdk
{
  ...
  class Waypoint : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->staytime >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->staytime >> (8 * 1)) & 0xFF;
      offset += sizeof(this->staytime);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->heading);
      this->staytime =  ((uint16_t) (*(inbuffer + offset)));
      this->staytime |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->staytime);
     return offset;
    }

    const char * getType(){ return "dji_sdk/Waypoint"; };
    const char * getMD5(){ return "1d0881fabe75ce713c47829a8aa66d90"; };
