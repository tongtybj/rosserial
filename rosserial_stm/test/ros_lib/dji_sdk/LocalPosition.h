#ifndef _ROS_dji_sdk_LocalPosition_h
#define _ROS_dji_sdk_LocalPosition_h
...
namespace dji_sdk
{
  ...
  class LocalPosition : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dji_sdk/LocalPosition"; };
    const char * getMD5(){ return "933ce5db06b6bff36785c58a964ad3c7"; };
