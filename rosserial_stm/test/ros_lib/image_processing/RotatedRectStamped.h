#ifndef _ROS_image_processing_RotatedRectStamped_h
#define _ROS_image_processing_RotatedRectStamped_h
...
namespace image_processing
{
  ...
  class RotatedRectStamped : public ros::Msg
  {
    ...
    const char * getType(){ return "image_processing/RotatedRectStamped"; };
    const char * getMD5(){ return "57345f97f12b3b711f27a5bd191b3e16"; };
