#ifndef _ROS_aerial_robot_msgs_YawThrottleGain_h
#define _ROS_aerial_robot_msgs_YawThrottleGain_h
...
namespace aerial_robot_msgs
{
  ...
  class YawThrottleGain : public ros::Msg
  {
    ...
    const char * getType(){ return "aerial_robot_msgs/YawThrottleGain"; };
