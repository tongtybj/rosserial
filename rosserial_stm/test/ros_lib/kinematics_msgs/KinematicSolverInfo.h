#ifndef _ROS_kinematics_msgs_KinematicSolverInfo_h
#define _ROS_kinematics_msgs_KinematicSolverInfo_h
...
namespace kinematics_msgs
{
  ...
  class KinematicSolverInfo : public ros::Msg
  {
    ...
    const char * getType(){ return "kinematics_msgs/KinematicSolverInfo"; };
