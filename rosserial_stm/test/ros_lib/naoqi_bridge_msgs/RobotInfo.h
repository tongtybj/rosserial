...
namespace naoqi_bridge_msgs
{
  ...
  class RobotInfo : public ros::Msg
  {
    public:
      uint8_t type;
      const char* model;
      const char* head_version;
      const char* body_version;
      const char* arm_version;
      bool has_laser;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->type >> (8 * 0)) & 0xFF;
      ...
      memcpy(outbuffer + offset, &length_head_version, sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(outbuffer + offset, &length_body_version, sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(outbuffer + offset, &length_arm_version, sizeof(uint32_t));
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      memcpy(&length_head_version, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(&length_body_version, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(&length_arm_version, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
