...
namespace arm_navigation_msgs
{
  ...
  class ContactInformation : public ros::Msg
  {
    public:
      ...
      const char* attached_body_1;
      uint32_t body_type_1;
      const char* contact_body_2;
      const char* attached_body_2;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 7) = (u_depth.base >> (8 * 7)) & 0xFF;
      ...
      memcpy(outbuffer + offset, &length_attached_body_1, sizeof(uint32_t));
      offset += 4;
      ...
      *(outbuffer + offset + 3) = (this->body_type_1 >> (8 * 3)) & 0xFF;
      ...
      memcpy(outbuffer + offset, &length_attached_body_2, sizeof(uint32_t));
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      memcpy(&length_attached_body_1, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(&length_attached_body_2, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
