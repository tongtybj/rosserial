#ifndef _ROS_hrpsys_gazebo_msgs_RobotState_h
#define _ROS_hrpsys_gazebo_msgs_RobotState_h
...
namespace hrpsys_gazebo_msgs
{
  ...
  class RobotState : public ros::Msg
  {
    public:
      ...
      double st_effort;
      double * effort;
      uint8_t ref_position_length;
      double st_ref_position;
      double * ref_position;
      uint8_t ref_velocity_length;
      double st_ref_velocity;
      double * ref_velocity;
      ...
      float * kpv_velocity;
      uint8_t Imus_length;
      hrpsys_gazebo_msgs::NamedImu st_Imus;
      hrpsys_gazebo_msgs::NamedImu * Imus;
      uint8_t sensors_length;
      hrpsys_gazebo_msgs::NamedWrench st_sensors;
      hrpsys_gazebo_msgs::NamedWrench * sensors;
    ...
    RobotState():
      ...
      ref_position_length(0), ref_position(NULL),
      ref_velocity_length(0), ref_velocity(NULL),
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = ref_position_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < ref_position_length; i++){
      union {
        double real;
        uint64_t base;
      } u_ref_positioni;
      u_ref_positioni.real = this->ref_position[i];
      *(outbuffer + offset + 0) = (u_ref_positioni.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_ref_positioni.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_ref_positioni.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_ref_positioni.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_ref_positioni.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_ref_positioni.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_ref_positioni.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_ref_positioni.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->ref_position[i]);
      }
      *(outbuffer + offset++) = ref_velocity_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < ref_velocity_length; i++){
      union {
        double real;
        uint64_t base;
      } u_ref_velocityi;
      u_ref_velocityi.real = this->ref_velocity[i];
      *(outbuffer + offset + 0) = (u_ref_velocityi.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_ref_velocityi.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_ref_velocityi.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_ref_velocityi.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_ref_velocityi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_ref_velocityi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_ref_velocityi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_ref_velocityi.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->ref_velocity[i]);
      }
      ...
      *(outbuffer + offset++) = Imus_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < Imus_length; i++){
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint8_t ref_position_lengthT = *(inbuffer + offset++);
      if(ref_position_lengthT > ref_position_length)
        this->ref_position = (double*)realloc(this->ref_position, ref_position_lengthT * sizeof(double));
      offset += 3;
      ref_position_length = ref_position_lengthT;
      for( uint8_t i = 0; i < ref_position_length; i++){
      union {
        double real;
        uint64_t base;
      } u_st_ref_position;
      u_st_ref_position.base = 0;
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_ref_position.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_ref_position = u_st_ref_position.real;
      offset += sizeof(this->st_ref_position);
        memcpy( &(this->ref_position[i]), &(this->st_ref_position), sizeof(double));
      }
      uint8_t ref_velocity_lengthT = *(inbuffer + offset++);
      if(ref_velocity_lengthT > ref_velocity_length)
        this->ref_velocity = (double*)realloc(this->ref_velocity, ref_velocity_lengthT * sizeof(double));
      offset += 3;
      ref_velocity_length = ref_velocity_lengthT;
      for( uint8_t i = 0; i < ref_velocity_length; i++){
      union {
        double real;
        uint64_t base;
      } u_st_ref_velocity;
      u_st_ref_velocity.base = 0;
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_ref_velocity.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_ref_velocity = u_st_ref_velocity.real;
      offset += sizeof(this->st_ref_velocity);
        memcpy( &(this->ref_velocity[i]), &(this->st_ref_velocity), sizeof(double));
      }
      ...
      uint8_t Imus_lengthT = *(inbuffer + offset++);
      if(Imus_lengthT > Imus_length)
        this->Imus = (hrpsys_gazebo_msgs::NamedImu*)realloc(this->Imus, Imus_lengthT * sizeof(hrpsys_gazebo_msgs::NamedImu));
      offset += 3;
      Imus_length = Imus_lengthT;
      for( uint8_t i = 0; i < Imus_length; i++){
      offset += this->st_Imus.deserialize(inbuffer + offset);
        memcpy( &(this->Imus[i]), &(this->st_Imus), sizeof(hrpsys_gazebo_msgs::NamedImu));
      }
      uint8_t sensors_lengthT = *(inbuffer + offset++);
      if(sensors_lengthT > sensors_length)
        this->sensors = (hrpsys_gazebo_msgs::NamedWrench*)realloc(this->sensors, sensors_lengthT * sizeof(hrpsys_gazebo_msgs::NamedWrench));
      offset += 3;
      sensors_length = sensors_lengthT;
      for( uint8_t i = 0; i < sensors_length; i++){
      offset += this->st_sensors.deserialize(inbuffer + offset);
        memcpy( &(this->sensors[i]), &(this->st_sensors), sizeof(hrpsys_gazebo_msgs::NamedWrench));
      }
     return offset;
    }

    const char * getType(){ return "hrpsys_gazebo_msgs/RobotState"; };
    const char * getMD5(){ return "0e5119eeb4843d3845bd61c692d5c24e"; };
