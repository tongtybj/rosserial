#ifndef _ROS_pal_behaviour_msgs_BehaviourArgument_h
#define _ROS_pal_behaviour_msgs_BehaviourArgument_h
...
namespace pal_behaviour_msgs
{
  ...
  class BehaviourArgument : public ros::Msg
  {
    public:
      const char* key;
      const char* value;
    ...
    const char * getType(){ return "pal_behaviour_msgs/BehaviourArgument"; };
